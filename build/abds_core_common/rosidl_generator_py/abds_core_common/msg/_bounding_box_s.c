...
bool abds_core_common__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abds_core_common.msg._bounding_box.BoundingBox", full_classname_dest, 46) == 0);
  }
  abds_core_common__msg__BoundingBox * ros_message = _ros_message;
  {  // centroid
...
PyObject * abds_core_common__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("abds_core_common.msg._bounding_box");
