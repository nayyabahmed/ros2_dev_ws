...
bool abds_core_common__msg__trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abds_core_common.msg._trajectory_point.TrajectoryPoint", full_classname_dest, 54) == 0);
  }
  abds_core_common__msg__TrajectoryPoint * ros_message = _ros_message;
  {  // time_from_start
  ...
  {  // instantenious_curvature
    PyObject * field = PyObject_GetAttrString(_pymsg, "instantenious_curvature");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->instantenious_curvature = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * abds_core_common__msg__trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("abds_core_common.msg._trajectory_point");
  ...
  {  // instantenious_curvature
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->instantenious_curvature);
    {
      int rc = PyObject_SetAttrString(_pymessage, "instantenious_curvature", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
