...
bool abds_core_common__msg__vehicle_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abds_core_common.msg._vehicle_command.VehicleCommand", full_classname_dest, 52) == 0);
  }
  abds_core_common__msg__VehicleCommand * ros_message = _ros_message;
  {  // stamp
...
PyObject * abds_core_common__msg__vehicle_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("abds_core_common.msg._vehicle_command");
