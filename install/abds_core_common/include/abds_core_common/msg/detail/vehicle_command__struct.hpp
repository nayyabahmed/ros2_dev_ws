...
#ifndef ABDS_CORE_COMMON__MSG__DETAIL__VEHICLE_COMMAND__STRUCT_HPP_
#define ABDS_CORE_COMMON__MSG__DETAIL__VEHICLE_COMMAND__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__abds_core_common__msg__VehicleCommand __attribute__((deprecated))
#else
# define DEPRECATED__abds_core_common__msg__VehicleCommand __declspec(deprecated)
#endif
...
struct VehicleCommand_
{
  ...
  // pointer types
  using RawPtr =
    abds_core_common::msg::VehicleCommand_<ContainerAllocator> *;
  using ConstRawPtr =
    const abds_core_common::msg::VehicleCommand_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<abds_core_common::msg::VehicleCommand_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<abds_core_common::msg::VehicleCommand_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      abds_core_common::msg::VehicleCommand_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<abds_core_common::msg::VehicleCommand_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<abds_core_common::msg::VehicleCommand_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<abds_core_common::msg::VehicleCommand_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<abds_core_common::msg::VehicleCommand_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__abds_core_common__msg__VehicleCommand
    std::shared_ptr<abds_core_common::msg::VehicleCommand_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__abds_core_common__msg__VehicleCommand
    std::shared_ptr<abds_core_common::msg::VehicleCommand_<ContainerAllocator> const>
...
using VehicleCommand =
  abds_core_common::msg::VehicleCommand_<std::allocator<void>>;
...
#endif  // ABDS_CORE_COMMON__MSG__DETAIL__VEHICLE_COMMAND__STRUCT_HPP_
