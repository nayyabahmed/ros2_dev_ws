    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'abds_core_common.msg.Trajectory')
            logger.debug(
            ...
            from abds_core_common.msg import TrajectoryPoint
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<abds_core_common/TrajectoryPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['abds_core_common', 'msg'], 'TrajectoryPoint')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'points' field must be a set or sequence and each value of type 'TrajectoryPoint'"
        self._points = value
