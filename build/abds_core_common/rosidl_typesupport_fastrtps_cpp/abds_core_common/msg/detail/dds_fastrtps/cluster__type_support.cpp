...
#include "abds_core_common/msg/detail/cluster__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const abds_core_common::msg::Cluster *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abds_core_common::msg::Cluster *>(
    untyped_ros_message);
...
{
  return &abds_core_common::msg::typesupport_fastrtps_cpp::_Cluster__handle;
}
