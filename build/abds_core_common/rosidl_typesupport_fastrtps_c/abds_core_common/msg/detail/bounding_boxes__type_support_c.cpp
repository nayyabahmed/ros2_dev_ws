...
#include "abds_core_common/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_c.h"
...
#include "abds_core_common/msg/detail/bounding_box__functions.h"  // boxes
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_abds_core_common__msg__BoundingBox(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_abds_core_common__msg__BoundingBox(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abds_core_common, msg, BoundingBox)();
...
using _BoundingBoxes__ros_msg_type = abds_core_common__msg__BoundingBoxes;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: boxes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, abds_core_common, msg, BoundingBox
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: boxes
  {
    ...
    if (ros_message->boxes.data) {
      abds_core_common__msg__BoundingBox__Sequence__fini(&ros_message->boxes);
    }
    if (!abds_core_common__msg__BoundingBox__Sequence__init(&ros_message->boxes, size)) {
...
size_t get_serialized_size_abds_core_common__msg__BoundingBoxes(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundingBoxes__ros_msg_type * ros_message = static_cast<const _BoundingBoxes__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_abds_core_common__msg__BoundingBox(
...
static uint32_t _BoundingBoxes__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abds_core_common__msg__BoundingBoxes(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abds_core_common
size_t max_serialized_size_abds_core_common__msg__BoundingBoxes(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_abds_core_common__msg__BoundingBox(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_abds_core_common__msg__BoundingBoxes(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abds_core_common, msg, BoundingBoxes)() {
