...
#include "rc_interfaces/msg/detail/rc_status__type_support.h"
#include "rc_interfaces/msg/detail/rc_status__struct.h"
#include "rc_interfaces/msg/detail/rc_status__functions.h"

static void * rc_interfaces__msg__rc_status__create_ros_message(void)
{
  return rc_interfaces__msg__RcStatus__create();
}

static void rc_interfaces__msg__rc_status__destroy_ros_message(void * raw_ros_message)
{
  rc_interfaces__msg__RcStatus * ros_message = (rc_interfaces__msg__RcStatus *)raw_ros_message;
  rc_interfaces__msg__RcStatus__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool rc_interfaces__msg__rc_status__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
ROSIDL_GET_MSG_TYPE_SUPPORT(rc_interfaces, msg, RcStatus);

int8_t
_register_msg_type__msg__rc_status(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&rc_interfaces__msg__rc_status__create_ros_message,
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__rc_status",
  ...
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&rc_interfaces__msg__rc_status__destroy_ros_message,
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__rc_status",
  ...
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&rc_interfaces__msg__rc_status__convert_from_py,
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__rc_status",
  ...
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&rc_interfaces__msg__rc_status__convert_to_py,
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__rc_status",
  ...
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(rc_interfaces, msg, RcStatus),
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__rc_status",
...
PyMODINIT_FUNC
PyInit_rc_interfaces_s__rosidl_typesupport_introspection_c(void)
{
  ...
  err = _register_msg_type__msg__rc_status(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }
