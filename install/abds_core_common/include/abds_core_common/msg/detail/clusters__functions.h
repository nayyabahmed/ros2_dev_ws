...
#ifndef ABDS_CORE_COMMON__MSG__DETAIL__CLUSTERS__FUNCTIONS_H_
#define ABDS_CORE_COMMON__MSG__DETAIL__CLUSTERS__FUNCTIONS_H_
 ...
 * calls
 * abds_core_common__msg__Clusters__init().
...
/**
 * It calls
 * abds_core_common__msg__Clusters__fini()
 ...
 * abds_core_common__msg__Clusters__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * abds_core_common__msg__Clusters__Sequence__fini()
 * on the array,
...
#endif  // ABDS_CORE_COMMON__MSG__DETAIL__CLUSTERS__FUNCTIONS_H_
