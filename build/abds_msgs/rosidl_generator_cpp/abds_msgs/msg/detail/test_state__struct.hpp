...
#ifndef ABDS_MSGS__MSG__DETAIL__TEST_STATE__STRUCT_HPP_
#define ABDS_MSGS__MSG__DETAIL__TEST_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__abds_msgs__msg__TestState __attribute__((deprecated))
#else
# define DEPRECATED__abds_msgs__msg__TestState __declspec(deprecated)
#endif
...
struct TestState_
{
  ...
  // pointer types
  using RawPtr =
    abds_msgs::msg::TestState_<ContainerAllocator> *;
  using ConstRawPtr =
    const abds_msgs::msg::TestState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<abds_msgs::msg::TestState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<abds_msgs::msg::TestState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      abds_msgs::msg::TestState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<abds_msgs::msg::TestState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<abds_msgs::msg::TestState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<abds_msgs::msg::TestState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<abds_msgs::msg::TestState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__abds_msgs__msg__TestState
    std::shared_ptr<abds_msgs::msg::TestState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__abds_msgs__msg__TestState
    std::shared_ptr<abds_msgs::msg::TestState_<ContainerAllocator> const>
...
using TestState =
  abds_msgs::msg::TestState_<std::allocator<void>>;
...
#endif  // ABDS_MSGS__MSG__DETAIL__TEST_STATE__STRUCT_HPP_
