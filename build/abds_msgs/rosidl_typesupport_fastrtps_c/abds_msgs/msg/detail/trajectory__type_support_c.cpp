...
#include "abds_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "abds_msgs/msg/detail/trajectory_point__functions.h"  // points
...
using _Trajectory__ros_msg_type = abds_msgs__msg__Trajectory;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      abds_msgs__msg__TrajectoryPoint__Sequence__fini(&ros_message->points);
    }
...
size_t get_serialized_size_abds_msgs__msg__Trajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory__ros_msg_type * ros_message = static_cast<const _Trajectory__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abds_msgs__msg__Trajectory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abds_msgs
size_t max_serialized_size_abds_msgs__msg__Trajectory(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_abds_msgs__msg__Trajectory(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abds_msgs, msg, Trajectory)() {
