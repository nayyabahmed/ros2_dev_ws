...
#include <stddef.h>
#include "abds_msgs/msg/detail/vehicle_command__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember VehicleCommand__rosidl_typesupport_introspection_c__VehicleCommand_message_member_array[5] = {
  {
    ...
    offsetof(abds_msgs__msg__VehicleCommand, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abds_msgs__msg__VehicleCommand, long_accel),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abds_msgs__msg__VehicleCommand, velocity_modifier),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abds_msgs__msg__VehicleCommand, front_wheel_angle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abds_msgs__msg__VehicleCommand, rear_wheel_angle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleCommand__rosidl_typesupport_introspection_c__VehicleCommand_message_members = {
  ...
  5,  // number of fields
  sizeof(abds_msgs__msg__VehicleCommand),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abds_msgs, msg, VehicleCommand)() {
