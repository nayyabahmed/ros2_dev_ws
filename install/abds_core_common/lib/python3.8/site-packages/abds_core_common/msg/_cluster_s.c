...
bool abds_core_common__msg__cluster__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abds_core_common.msg._cluster.Cluster", full_classname_dest, 37) == 0);
  }
  abds_core_common__msg__Cluster * ros_message = _ros_message;
  {  // points
...
PyObject * abds_core_common__msg__cluster__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("abds_core_common.msg._cluster");
