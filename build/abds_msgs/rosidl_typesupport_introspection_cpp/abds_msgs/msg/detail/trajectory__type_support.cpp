...
{
  new (message_memory) abds_msgs::msg::Trajectory(_init);
}

void Trajectory_fini_function(void * message_memory)
{
  auto typed_message = static_cast<abds_msgs::msg::Trajectory *>(message_memory);
  typed_message->~Trajectory();
}

size_t size_function__Trajectory__points(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<abds_msgs::msg::TrajectoryPoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<abds_msgs::msg::TrajectoryPoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<abds_msgs::msg::TrajectoryPoint> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Trajectory_message_member_array[2] = {
  {
    ...
    offsetof(abds_msgs::msg::Trajectory, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abds_msgs::msg::Trajectory, points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Trajectory_message_members = {
  ...
  2,  // number of fields
  sizeof(abds_msgs::msg::Trajectory),
...
{
  return &::abds_msgs::msg::rosidl_typesupport_introspection_cpp::Trajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, abds_msgs, msg, Trajectory)() {
  return &::abds_msgs::msg::rosidl_typesupport_introspection_cpp::Trajectory_message_type_support_handle;
}
