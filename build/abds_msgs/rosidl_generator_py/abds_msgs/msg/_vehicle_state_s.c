...
bool abds_msgs__msg__vehicle_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abds_msgs.msg._vehicle_state.VehicleState", full_classname_dest, 41) == 0);
  }
  abds_msgs__msg__VehicleState * ros_message = _ros_message;
  {  // header
  ...
  {  // state
    ...
    if (!abds_msgs__msg__trajectory_point__convert_from_py(field, &ros_message->state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * abds_msgs__msg__vehicle_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("abds_msgs.msg._vehicle_state");
  ...
  {  // state
    PyObject * field = NULL;
    field = abds_msgs__msg__trajectory_point__convert_to_py(&ros_message->state);
    if (!field) {
      return NULL;
    }
    {
