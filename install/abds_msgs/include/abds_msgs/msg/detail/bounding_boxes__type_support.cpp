...
{
  new (message_memory) abds_msgs::msg::BoundingBoxes(_init);
}

void BoundingBoxes_fini_function(void * message_memory)
{
  auto typed_message = static_cast<abds_msgs::msg::BoundingBoxes *>(message_memory);
  typed_message->~BoundingBoxes();
}

size_t size_function__BoundingBoxes__boxes(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<abds_msgs::msg::BoundingBox> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<abds_msgs::msg::BoundingBox> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<abds_msgs::msg::BoundingBox> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBoxes_message_member_array[2] = {
  {
    ...
    offsetof(abds_msgs::msg::BoundingBoxes, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<abds_msgs::msg::BoundingBox>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(abds_msgs::msg::BoundingBoxes, boxes),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBoxes_message_members = {
  ...
  2,  // number of fields
  sizeof(abds_msgs::msg::BoundingBoxes),
...
get_message_type_support_handle<abds_msgs::msg::BoundingBoxes>()
{
  return &::abds_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, abds_msgs, msg, BoundingBoxes)() {
  return &::abds_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}
