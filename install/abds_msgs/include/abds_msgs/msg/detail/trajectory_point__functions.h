...
#ifndef ABDS_MSGS__MSG__DETAIL__TRAJECTORY_POINT__FUNCTIONS_H_
#define ABDS_MSGS__MSG__DETAIL__TRAJECTORY_POINT__FUNCTIONS_H_
 ...
 * calls
 * abds_msgs__msg__TrajectoryPoint__init().
...
/**
 * It calls
 * abds_msgs__msg__TrajectoryPoint__fini()
 ...
 * abds_msgs__msg__TrajectoryPoint__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * abds_msgs__msg__TrajectoryPoint__Sequence__fini()
 * on the array,
...
#endif  // ABDS_MSGS__MSG__DETAIL__TRAJECTORY_POINT__FUNCTIONS_H_
