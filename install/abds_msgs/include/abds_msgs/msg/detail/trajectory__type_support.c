...
#include <stddef.h>
#include "abds_msgs/msg/detail/trajectory__rosidl_typesupport_introspection_c.h"
...
// Member `points`
#include "abds_msgs/msg/trajectory_point.h"
// Member `points`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  abds_msgs__msg__Trajectory__init(message_memory);
}

void Trajectory__rosidl_typesupport_introspection_c__Trajectory_fini_function(void * message_memory)
{
  abds_msgs__msg__Trajectory__fini(message_memory);
}

size_t Trajectory__rosidl_typesupport_introspection_c__size_function__TrajectoryPoint__points(
  const void * untyped_member)
{
  const abds_msgs__msg__TrajectoryPoint__Sequence * member =
    (const abds_msgs__msg__TrajectoryPoint__Sequence *)(untyped_member);
  return member->size;
}
...
{
  abds_msgs__msg__TrajectoryPoint__Sequence * member =
    (abds_msgs__msg__TrajectoryPoint__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  abds_msgs__msg__TrajectoryPoint__Sequence * member =
    (abds_msgs__msg__TrajectoryPoint__Sequence *)(untyped_member);
  abds_msgs__msg__TrajectoryPoint__Sequence__fini(member);
  return abds_msgs__msg__TrajectoryPoint__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember Trajectory__rosidl_typesupport_introspection_c__Trajectory_message_member_array[2] = {
  {
    ...
    offsetof(abds_msgs__msg__Trajectory, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abds_msgs__msg__Trajectory, points),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Trajectory__rosidl_typesupport_introspection_c__Trajectory_message_members = {
  ...
  2,  // number of fields
  sizeof(abds_msgs__msg__Trajectory),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abds_msgs, msg, Trajectory)() {
