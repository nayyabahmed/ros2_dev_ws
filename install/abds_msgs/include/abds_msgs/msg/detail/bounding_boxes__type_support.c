...
#include <stddef.h>
#include "abds_msgs/msg/detail/bounding_boxes__rosidl_typesupport_introspection_c.h"
...
// Member `boxes`
#include "abds_msgs/msg/bounding_box.h"
// Member `boxes`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  abds_msgs__msg__BoundingBoxes__init(message_memory);
}

void BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_fini_function(void * message_memory)
{
  abds_msgs__msg__BoundingBoxes__fini(message_memory);
}

size_t BoundingBoxes__rosidl_typesupport_introspection_c__size_function__BoundingBox__boxes(
  const void * untyped_member)
{
  const abds_msgs__msg__BoundingBox__Sequence * member =
    (const abds_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  return member->size;
}
...
{
  abds_msgs__msg__BoundingBox__Sequence * member =
    (abds_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  abds_msgs__msg__BoundingBox__Sequence * member =
    (abds_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  abds_msgs__msg__BoundingBox__Sequence__fini(member);
  return abds_msgs__msg__BoundingBox__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_member_array[2] = {
  {
    ...
    offsetof(abds_msgs__msg__BoundingBoxes, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abds_msgs__msg__BoundingBoxes, boxes),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_members = {
  ...
  2,  // number of fields
  sizeof(abds_msgs__msg__BoundingBoxes),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abds_msgs, msg, BoundingBoxes)() {
