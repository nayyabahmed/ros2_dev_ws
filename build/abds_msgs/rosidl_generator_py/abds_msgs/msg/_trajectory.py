...
class Metaclass_Trajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from abds_msgs.msg import TrajectoryPoint
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<abds_msgs/TrajectoryPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['abds_msgs', 'msg'], 'TrajectoryPoint')),  # noqa: E501
    )
