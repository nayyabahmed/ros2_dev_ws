    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'abds_core_common.msg.VehicleState')
            logger.debug(
...
class VehicleState(metaclass=Metaclass_VehicleState):
    ...
    _fields_and_field_types = {
        ...
        'state': 'abds_core_common/TrajectoryPoint',
        'delta': 'geometry_msgs/Transform',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['abds_core_common', 'msg'], 'TrajectoryPoint'),  # noqa: E501
