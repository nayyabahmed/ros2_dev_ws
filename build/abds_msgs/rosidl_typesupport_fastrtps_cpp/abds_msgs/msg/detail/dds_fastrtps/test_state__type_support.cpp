...
#include "abds_msgs/msg/detail/test_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abds_msgs::msg::TestState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abds_msgs::msg::TestState & ros_message)
{
  // Member: test_id
  cdr >> ros_message.test_id;
...
{
  auto typed_message =
    static_cast<const abds_msgs::msg::TestState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abds_msgs::msg::TestState *>(
    untyped_ros_message);
...
get_message_type_support_handle<abds_msgs::msg::TestState>()
{
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_TestState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abds_msgs, msg, TestState)() {
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_TestState__handle;
}
