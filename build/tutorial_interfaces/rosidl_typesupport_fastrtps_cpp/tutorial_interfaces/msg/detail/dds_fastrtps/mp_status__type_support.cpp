...
#include "tutorial_interfaces/msg/detail/mp_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::msg::MpStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::MpStatus & ros_message)
{
  // Member: mp_time
  cdr >> ros_message.mp_time;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::MpStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::MpStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MpStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::MpStatus *>(
...
{
  return max_serialized_size_MpStatus(full_bounded, 0);
}

static message_type_support_callbacks_t _MpStatus__callbacks = {
...
static rosidl_message_type_support_t _MpStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MpStatus__callbacks,
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_MpStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, MpStatus)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_MpStatus__handle;
}
