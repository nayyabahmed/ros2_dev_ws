...
#ifndef ABDS_CORE_COMMON__MSG__DETAIL__BOUNDING_BOX__STRUCT_HPP_
#define ABDS_CORE_COMMON__MSG__DETAIL__BOUNDING_BOX__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__abds_core_common__msg__BoundingBox __attribute__((deprecated))
#else
# define DEPRECATED__abds_core_common__msg__BoundingBox __declspec(deprecated)
#endif
...
struct BoundingBox_
{
  ...
  // pointer types
  using RawPtr =
    abds_core_common::msg::BoundingBox_<ContainerAllocator> *;
  using ConstRawPtr =
    const abds_core_common::msg::BoundingBox_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<abds_core_common::msg::BoundingBox_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<abds_core_common::msg::BoundingBox_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      abds_core_common::msg::BoundingBox_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<abds_core_common::msg::BoundingBox_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<abds_core_common::msg::BoundingBox_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<abds_core_common::msg::BoundingBox_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<abds_core_common::msg::BoundingBox_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__abds_core_common__msg__BoundingBox
    std::shared_ptr<abds_core_common::msg::BoundingBox_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__abds_core_common__msg__BoundingBox
    std::shared_ptr<abds_core_common::msg::BoundingBox_<ContainerAllocator> const>
...
using BoundingBox =
  abds_core_common::msg::BoundingBox_<std::allocator<void>>;
...
#endif  // ABDS_CORE_COMMON__MSG__DETAIL__BOUNDING_BOX__STRUCT_HPP_
