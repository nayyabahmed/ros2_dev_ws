...
static const _TrajectoryPoint_type_support_symbol_names_t _TrajectoryPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abds_core_common, msg, TrajectoryPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, abds_core_common, msg, TrajectoryPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, abds_core_common, msg, TrajectoryPoint)() {
  return &::abds_core_common::msg::rosidl_typesupport_c::TrajectoryPoint_message_type_support_handle;
}
