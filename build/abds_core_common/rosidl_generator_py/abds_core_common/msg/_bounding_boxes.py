    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'abds_core_common.msg.BoundingBoxes')
            logger.debug(
            ...
            from abds_core_common.msg import BoundingBox
...
class BoundingBoxes(metaclass=Metaclass_BoundingBoxes):
    ...
    _fields_and_field_types = {
        ...
        'boxes': 'sequence<abds_core_common/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['abds_core_common', 'msg'], 'BoundingBox')),  # noqa: E501
    )
