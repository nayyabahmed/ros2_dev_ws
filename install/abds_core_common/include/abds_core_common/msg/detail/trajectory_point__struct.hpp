...
#ifndef ABDS_CORE_COMMON__MSG__DETAIL__TRAJECTORY_POINT__STRUCT_HPP_
#define ABDS_CORE_COMMON__MSG__DETAIL__TRAJECTORY_POINT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__abds_core_common__msg__TrajectoryPoint __attribute__((deprecated))
#else
# define DEPRECATED__abds_core_common__msg__TrajectoryPoint __declspec(deprecated)
#endif
...
struct TrajectoryPoint_
{
    ...
    pose(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->instantenious_curvature = 0.0f;
    }
  }
  ...
  using _instantenious_curvature_type =
    float;
  _instantenious_curvature_type instantenious_curvature;
  ...
  Type & set__instantenious_curvature(
    const float & _arg)
  {
    this->instantenious_curvature = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const abds_core_common::msg::TrajectoryPoint_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<abds_core_common::msg::TrajectoryPoint_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<abds_core_common::msg::TrajectoryPoint_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      abds_core_common::msg::TrajectoryPoint_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<abds_core_common::msg::TrajectoryPoint_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<abds_core_common::msg::TrajectoryPoint_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<abds_core_common::msg::TrajectoryPoint_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<abds_core_common::msg::TrajectoryPoint_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__abds_core_common__msg__TrajectoryPoint
    std::shared_ptr<abds_core_common::msg::TrajectoryPoint_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__abds_core_common__msg__TrajectoryPoint
    std::shared_ptr<abds_core_common::msg::TrajectoryPoint_<ContainerAllocator> const>
  ...
  bool operator==(const TrajectoryPoint_ & other) const
  {
    ...
    if (this->instantenious_curvature != other.instantenious_curvature) {
      return false;
    }
    return true;
  }
...
using TrajectoryPoint =
  abds_core_common::msg::TrajectoryPoint_<std::allocator<void>>;
...
#endif  // ABDS_CORE_COMMON__MSG__DETAIL__TRAJECTORY_POINT__STRUCT_HPP_
