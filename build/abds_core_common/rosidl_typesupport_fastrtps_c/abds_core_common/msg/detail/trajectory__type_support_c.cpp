...
#include "abds_core_common/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "abds_core_common/msg/detail/trajectory_point__functions.h"  // points
...
using _Trajectory__ros_msg_type = abds_core_common__msg__Trajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, abds_core_common, msg, TrajectoryPoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      abds_core_common__msg__TrajectoryPoint__Sequence__fini(&ros_message->points);
    }
    if (!abds_core_common__msg__TrajectoryPoint__Sequence__init(&ros_message->points, size)) {
...
size_t get_serialized_size_abds_core_common__msg__Trajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory__ros_msg_type * ros_message = static_cast<const _Trajectory__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_abds_core_common__msg__TrajectoryPoint(
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abds_core_common__msg__Trajectory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abds_core_common
size_t max_serialized_size_abds_core_common__msg__Trajectory(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_abds_core_common__msg__TrajectoryPoint(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_abds_core_common__msg__Trajectory(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abds_core_common, msg, Trajectory)() {
