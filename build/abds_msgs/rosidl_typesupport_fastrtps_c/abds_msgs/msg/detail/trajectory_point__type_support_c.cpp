...
#include "abds_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryPoint__ros_msg_type = abds_msgs__msg__TrajectoryPoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: instantanious_curvature
  {
...
static uint32_t _TrajectoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abds_msgs__msg__TrajectoryPoint(
...
{
  return max_serialized_size_abds_msgs__msg__TrajectoryPoint(
    full_bounded, 0);
}
