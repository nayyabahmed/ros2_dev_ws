...
#include "abds_core_common/msg/detail/test_state__rosidl_typesupport_fastrtps_c.h"
...
using _TestState__ros_msg_type = abds_core_common__msg__TestState;
...
size_t get_serialized_size_abds_core_common__msg__TestState(
  const void * untyped_ros_message,
...
static uint32_t _TestState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abds_core_common__msg__TestState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abds_core_common
size_t max_serialized_size_abds_core_common__msg__TestState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_abds_core_common__msg__TestState(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abds_core_common, msg, TestState)() {
