...
class Metaclass_BoundingBoxes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from abds_msgs.msg import BoundingBox
...
class BoundingBoxes(metaclass=Metaclass_BoundingBoxes):
    ...
    _fields_and_field_types = {
        ...
        'boxes': 'sequence<abds_msgs/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['abds_msgs', 'msg'], 'BoundingBox')),  # noqa: E501
    )
