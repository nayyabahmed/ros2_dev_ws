...
#include "abds_msgs/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const abds_msgs::msg::BoundingBox &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_abds_msgs
cdr_serialize(
  const abds_msgs::msg::BoundingBoxes & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: boxes
  {
    ...
    for (size_t i = 0; i < size; i++) {
      abds_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.boxes[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abds_msgs::msg::BoundingBoxes & ros_message)
{
  // Member: header
  ...
  // Member: boxes
  {
    ...
    for (size_t i = 0; i < size; i++) {
      abds_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        abds_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        abds_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const abds_msgs::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abds_msgs::msg::BoundingBoxes *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_abds_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<abds_msgs::msg::BoundingBoxes>()
{
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abds_msgs, msg, BoundingBoxes)() {
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
