...
class TrajectoryPoint(metaclass=Metaclass_TrajectoryPoint):
    ...
    def __init__(self, **kwargs):
        ...
        self.instantenious_curvature = kwargs.get('instantenious_curvature', float())
    ...
    def __eq__(self, other):
        ...
        if self.heading_rate != other.heading_rate:
            return False
        if self.instantenious_curvature != other.instantenious_curvature:
            return False
        return True
    ...
    @property
    def instantenious_curvature(self):
        """Message field 'instantenious_curvature'."""
        return self._instantenious_curvature

    @instantenious_curvature.setter
    def instantenious_curvature(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'instantenious_curvature' field must be of type 'float'"
        self._instantenious_curvature = value
