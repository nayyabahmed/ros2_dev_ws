...
#include "abds_msgs/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abds_msgs::msg::BoundingBox & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abds_msgs::msg::BoundingBox & ros_message)
{
  // Member: centroid
...
{
  auto typed_message =
    static_cast<const abds_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abds_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abds_msgs, msg, BoundingBox)() {
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
