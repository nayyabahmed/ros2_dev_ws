...
#include "abds_msgs/msg/detail/vehicle_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abds_msgs::msg::VehicleCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abds_msgs::msg::VehicleCommand & ros_message)
{
  // Member: stamp
...
{
  auto typed_message =
    static_cast<const abds_msgs::msg::VehicleCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abds_msgs::msg::VehicleCommand *>(
    untyped_ros_message);
...
{
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_VehicleCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abds_msgs, msg, VehicleCommand)() {
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_VehicleCommand__handle;
}
