...
#include "abds_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abds_msgs::msg::TrajectoryPoint & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: instantanious_curvature
  cdr << ros_message.instantanious_curvature;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abds_msgs::msg::TrajectoryPoint & ros_message)
{
  // Member: time_from_start
  ...
  size_t current_alignment)
{
  ...
  // Member: instantanious_curvature
  {
    size_t item_size = sizeof(ros_message.instantanious_curvature);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const abds_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abds_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
get_message_type_support_handle<abds_msgs::msg::TrajectoryPoint>()
{
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abds_msgs, msg, TrajectoryPoint)() {
  return &abds_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
